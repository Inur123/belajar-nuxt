  ...
  <div class="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
    ...
    <nav class="fixed top-0 left-0 right-0 bg-white  shadow-md px-4 py-3 flex justify-between items-center z-30">
      <div class="flex items-center">
        ...
        <button 
          @click="toggleSidebar" 
          class="mr-2 p-1 rounded-lg text-gray-500 hover:bg-gray-100 md:hidden"
        >
      ...
      <div class="flex items-center space-x-4">
        ...
        <div class="relative group">
          ...
          <!-- Dropdown menu -->
          <div class="absolute right-0 mt-2 w-48 bg-white rounded-xl shadow-lg py-1 z-40 hidden group-hover:block">
            ...
            <a href="/login" class="block px-4 py-2 text-sm text-red-600 hover:bg-indigo-50">Sign out</a>
          </div>
        </div>
      </div>
    </nav>
        ...
        <div class="bg-white rounded-xl shadow-md p-6">
          ...
          <div class="space-y-4">
            <div class="flex items-center p-4 hover:bg-gray-50 rounded-lg transition-colors">
              ...
              <div class="flex-1">
                <p class="text-sm font-medium text-gray-800">New message from <span class="text-indigo-600">John Doe</span></p>
            ...
            <div class="flex items-center p-4 hover:bg-gray-50 rounded-lg transition-colors">
              ...
              <div class="flex-1">
                <p class="text-sm font-medium text-gray-800">Project <span class="text-indigo-600">Marketing Campaign</span> completed</p>
            ...
            <div class="flex items-center p-4 hover:bg-gray-50 rounded-lg transition-colors">
              ...
              <div class="flex-1">
                <p class="text-sm font-medium text-gray-800">System Alert: <span class="text-red-600">Storage almost full</span></p>
            ...
            <div class="flex items-center p-4 hover:bg-gray-50 rounded-lg transition-colors">
              ...
              <div class="flex-1">
                <p class="text-sm font-medium text-gray-800"><span class="text-indigo-600">Jane Smith</span> viewed your profile</p>
